...
const StudentSignup = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_API_URL || 'http://127.0.0.1:5000'}/api/auth/register`, {
                name: name.trim(),
                    ...
                    <Card className="border-none shadow-none bg-transparent">
                        ...
                        <CardContent className="px-0">
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                {/* Password Field */}
                                <div className="space-y-2">
                                    <Label htmlFor="password" title="Password is required" className="text-sm font-medium">Password *</Label>
                                    <Input
                                        id="password"
                                        type="password"
                                        value={password}
                                ...
                                <Button
                                    type="submit"
                                    disabled={isLoading || !name || !email || !branch || !rollNumber || !password}
